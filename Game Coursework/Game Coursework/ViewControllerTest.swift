...
class ViewControllerTest: UIViewController, subviewDelegateTest {
    ...
    @IBOutlet weak var PlayAgainButton: UIView!
    ...
    self.collisionBehavior.action =
    {
        ...
        DispatchQueue.main.asyncAfter(deadline: when)
        {
            ...
            label.text = "Total Score is " + String(self.CoinsCollectedTotalScore)
...
@IBAction func PlayAgain(_ sender: UIButton) {
    ...
    self.view.bringSubviewToFront(movingroadImage)
    self.view.bringSubviewToFront(SequenceOfTreeImages)
